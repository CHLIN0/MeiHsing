...
const faqs = [
    ...
    },
    {
        ...
        answer: '當然可以！美杏老師擁有逾四十年教學經驗，從零基礎啟蒙到進階演奏都有豐富的教學方法。無論是兒童、青少年或成人，都能找到適合的學習方式。',
    },
    {
        question: '樂齡學員也適合嗎？',
        answer: '非常適合！美杏老師長期投入樂齡音樂教育，目前帶領岡山長青學苑合唱團與民謠班，並擔任岡山樂齡中心音樂輔療講師。音樂學習沒有年齡限制，也能為日常生活帶來新的節奏與交流。',
    },
    {
        question: '老師教哪些類型的音樂？',
